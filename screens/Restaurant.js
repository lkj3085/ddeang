      ...
      <View>
        ...
        <View
          ...
          <View
            ...
            <Text style={{...FONTS.h3}}>{getBasketItemCount()} Cart</Text>
            <Text style={{...FONTS.h3, fontWeight: 'bold'}}>${sumOrder()}</Text>
          </View>
          <View
            style={{
              flexDirection: 'row',
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              />
              <Text style={{marginLeft: SIZES.padding, ...FONTS.h4}}>5882</Text>
            </View>
          </View>
